...
Add move-counter pulse animation whenever moves increment.


## Why This Phaser Change Matters
- This Phaser task (Add move-counter pulse animation whenever moves increment.) targets the engine competency for today: Input coordinate mapping, efficient rendering updates, containers, and animation feedback..
...
- Check Phaser API signatures while implementing Add move-counter pulse animation whenever moves increment. to avoid incorrect assumptions about method behavior.
- Use Phaser examples as implementation references for Add move-counter pulse animation whenever moves increment., then adapt them to your module architecture.
