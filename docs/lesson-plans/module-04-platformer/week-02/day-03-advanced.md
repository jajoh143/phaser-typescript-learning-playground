...
Use Phaser groups for collectibles and animate collection feedback.


## Why This Phaser Change Matters
- This Phaser task (Use Phaser groups for collectibles and animate collection feedback.) targets the engine competency for today: Physics tuning, collision-driven gameplay, control feel, and debug instrumentation..
...
- Check Phaser API signatures while implementing Use Phaser groups for collectibles and animate collection feedback. to avoid incorrect assumptions about method behavior.
- Use Phaser examples as implementation references for Use Phaser groups for collectibles and animate collection feedback., then adapt them to your module architecture.
