...
Layer UI text and world objects with explicit depth values and verify draw order.


## Why This Phaser Change Matters
- This Phaser task (Layer UI text and world objects with explicit depth values and verify draw order.) targets the engine competency for today: Core Phaser object creation, interactivity, tweens, depth, and scene events..
...
- Check Phaser API signatures while implementing Layer UI text and world objects with explicit depth values and verify draw order. to avoid incorrect assumptions about method behavior.
- Use Phaser examples as implementation references for Layer UI text and world objects with explicit depth values and verify draw order., then adapt them to your module architecture.
